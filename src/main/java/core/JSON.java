/*
 * Contract API
 * Through this API you can access contracts.
 *
...
public class JSON {
    ...
    public JSON(Boolean serializeNulls) {
        gson = createGson()
                ...
                .registerTypeAdapter(Double.class, (JsonSerializer<Double>) (src, typeOfSrc, context) -> new JsonPrimitive(BigDecimal.valueOf(src).setScale(2)))
                .create();
            ...
            switch (in.peek()) {
                ...
                default:
                    ...
                    try{
                        ...
                        return OffsetDateTime.parse(date + "Z");
                    }
